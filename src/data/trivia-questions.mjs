export const questions = [
  ...
  {
    claim:
      "If you have COVID and aren’t showing symptoms you won’t transmit the disease.",
    fact: false,
    explanation:
  ...
  {
    claim:
      "Covid only affects older people, so young people don’t have to worry about it.",
    fact: false,
    explanation:
